...
tuningFileName = "tuned_augmented_model_both_grayscale"
plotFileName = "Both_Augmented_%s_epochs_grayscale"%(epochs)
modelFileName = "train_Augmented_model_%s_epochs_both"%(epochs)
