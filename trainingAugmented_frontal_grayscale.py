...
tuningFileName = "tuned_augmented_model_frontal_grayscale"
plotFileName = "Augmented_frontal_%s_epochs"%(epochs)
modelFileName = "train_Augmented_model_%s_epochs_frontal"%(epochs)
