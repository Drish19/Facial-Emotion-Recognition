...
seedNum = 1234
epochs = 30 # number of times model will be trained 
batchSize = 500

plotFileName = "Final_Frontal_%s_epochs_grayscale"%(epochs)
modelFileName = "Final_train_model_%s_epochs_frontal"%(epochs)
