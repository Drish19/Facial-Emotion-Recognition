####
#   Training Model with the augmented grayscale images for frontal faces only
###
...
seedNum = 1234
epochs = 100 # number of times model will be trained
batchSize = 500

plotFileName = "final_Augmented_frontal_%s_epochs"%(epochs)
modelFileName = "Final_train_Augmented_model_%s_epochs_frontal"%(epochs)
...
train_dt, validation_dt= keras.preprocessing.image_dataset_from_directory(directory= 'augmented_train_frontal',
                                                            labels= "inferred",
