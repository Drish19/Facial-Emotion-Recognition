...
#	Cleaned data GrayScale
#   Both Frontal and profile Faces
###
...
seedNum = 1234
epochs = 25 # number of times model will be trained
batchSize = 500

plotFileName = "Final_both_%s_epochs_grayscale"%(epochs)
modelFileName = "Final_train_model_%s_epochs_both"%(epochs)
...
train_dt, validation_dt= keras.preprocessing.image_dataset_from_directory(directory= 'train_both',
                                                            labels= "inferred",
